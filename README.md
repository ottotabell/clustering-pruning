...
This repository contains the R-codes that were used for simulation in Section 6, and in obtaining the causal effect identifying formulas in the paper Clustering and Pruning in Causal Data Fusion (Tabell, Tikka & Karvanen, 2025). The R-package do-search (Tikka et al., 2024) was used in the simulation and examples. 
...
| `\simulation` | Folder containing the codes for the simulation in **Section 6 and Appendix E** |
...
| `03_idinvariant.R` | R implementation of graph reduction operations by Tabell et al. 2025. |
...
| `07_simulation.R` | Testing `05_simulation.R` |
| `clustering*` | Codes for running the simulation and analyzing the data, and the analyzed data for clustering alone |
| `clustering_pruning*` | Codes for running the simulation and analyzing the data, and the analyzed data for clustering and pruning together |
| `pruning*` | Codes for running the simulation and analyzing the data, and the analyzed data for pruning alone |
